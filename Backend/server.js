...
app.post("/metadata-update", (req, res) => {
  ...
  const command = `cd "C:/Users/DELL/Downloads/exiftool-12.97_64/exiftool-12.97_64" && exiftool -Title="This video is ${result}" -Description="Deepfake Detection Prediction: ${accuracy}%" ${filePath}`;
